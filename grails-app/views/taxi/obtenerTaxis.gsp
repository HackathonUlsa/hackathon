...
<div class="col-md-3">
    ...
    <a class="btn btn-primary" href="${createLink(controller:"taxi" , action: "create")}">Agregar Taxi</a>
...
<div class="x_content">
    <table id="example" class="table table-striped responsive-utilities jambo_table">
        ...
        <tbody>
        <g:each in="${taxis}" var="taxi">
            <tr class="even pointer">
                <td >${taxi.chofer.usuario.persona.nombre} ${taxi.chofer.usuario.persona.apPaterno} ${taxi.chofer.usuario.persona.apMaterno}</td>
                <td>${taxi.numero}</td>
                <td>${taxi.numPlaca}</td>
