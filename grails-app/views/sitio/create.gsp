...
<form class="form-horizontal form-label-left" method="POST" novalidate>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input id="apelidoPaterno" class="form-control col-md-7 col-xs-12" name="direccion" placeholder="Apellido paterno" required="required" type="text">
        </div>
    </div>
    ...
    <div class="item form-group">
        <div class="col-md-6 col-md-offset-3">
            <a class="btn btn-primary" href="${createLink(controller:"sitio" , action: "save")}">Cancelar</a>
            <input type="submit" class="btn btn-success" formaction="${createLink(controller:"sitio" , action: "save")}" value="Guardar">
        </div>
    </div>
